...
public class Reports extends javax.swing.JPanel {
    ...
    try {
        ...
        for (com.mycompany.models.Lendings lending : daoLendings.listar()) {
            // Obtener usuario y libro por sus IDs
            com.mycompany.models.Users user = daoUsers.getUserById(lending.getUser_id());
            com.mycompany.models.Books book = daoBooks.getBookById(lending.getBook_id());
            
            // Crear nombre completo con apellidos
            String nombreCompleto = "Usuario no encontrado";
            if (user != null) {
                nombreCompleto = user.getName() + " " + 
                               user.getLast_name_p() + 
                               (user.getLast_name_m() != null ? " " + user.getLast_name_m() : "");
            }
            
            model.addRow(new Object[]{
                nombreCompleto,  // Nombre completo con apellidos
                book != null ? book.getTitle() : "Libro no encontrado",
                lending.getDate_out(),
                lending.getDate_return() != null ? lending.getDate_return() : "Pendiente"
            });
        }
    } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lector", "Libro", "Fecha de Salida", "Fecha de Entrega"
            }
        ) {
