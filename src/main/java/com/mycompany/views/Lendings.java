...
public class Lendings extends javax.swing.JPanel {
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        try {
            ...
            lending.setBook_id(currentBook.getBook_id());
            lending.setUser_id(currentUser.getUser_id());
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Libro ID: " + currentBook.getBook_id() + " prestado exitosamente a " + currentUser.getName() + ".\n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            folioTxt.setText("");
            libroIdTxt.setText("");
        } catch (Exception e) {
